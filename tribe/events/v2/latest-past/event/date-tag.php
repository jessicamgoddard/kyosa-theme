...
$event_day			 = $event->dates->start_display->format_i18n( 'l' );
$event_month     = $event->dates->start_display->format_i18n( 'F' );
...
<div class="tribe-events-calendar-latest-past__event-date-tag tribe-common-g-col">
	<time class="tribe-events-calendar-latest-past__event-date-tag-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
		<span class="tribe-events-calendar-latest-past__event-date-tag-day">

...
function kyosa_scripts_styles() {
  ...
  wp_enqueue_style( 'kyosa-theme-inline-css', get_stylesheet_directory_uri() . '/assets/dist/inline.min.css' );
...
function kyosa_gutenberg_scripts_styles() {
  ...
  wp_enqueue_style( 'kyosa-theme-editor-inline-css', get_stylesheet_directory_uri() . '/assets/dist/inline.min.css' );
